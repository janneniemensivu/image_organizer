...
class TestFileProcessor(unittest.TestCase):
    ...
    def test_image_files_are_moved_to_appropriate_year_folders(self):
        ...
        shutil.copy(self.test_files["image_2011"], os.path.join(self.src_folder, "image1.jpg"))
        shutil.copy(self.test_files["image_2012"], os.path.join(self.src_folder, "image2.jpg"))
    ...
    def test_multiple_subfolders(self):
        ...
        shutil.copy(self.test_files["image_2011"], os.path.join(self.src_folder, "folder_1", "image_1.jpg"))
        shutil.copy(self.test_files["image_2012"], os.path.join(self.src_folder, "folder_2", "image_2.jpg"))
        ...
        # Check that images are moved to appropriate year folders
        self.assertTrue(os.path.exists(os.path.join(self.dst_folder, "images", "2011", "image_1.jpg")))
        self.assertTrue(os.path.exists(os.path.join(self.dst_folder, "images", "2012", "image_2.jpg")))
    ...
    def test_empty_folders_deletion(self):
        ...
        shutil.copy(self.test_files["image_2011"], os.path.join(folder1_path, "image_2011.jpg"))
        shutil.copy(self.test_files["image_2012"], os.path.join(folder2_path, "image_2012.jpg"))
    ...
    def test_multiple_copies_same_file(self):
        ...
        files_in_2011 = [f for f in os.listdir(os.path.join(self.dst_folder, "images", "2011")) if f.endswith(".jpg")]
    ...
    def test_same_filename_in_different_folders(self):
        ...
        os.makedirs(os.path.join(self.src_folder, "folder_1"), exist_ok=True)
        shutil.copy(self.test_files["image_2011"], os.path.join(self.src_folder, "folder_1", "image1.jpg"))

        os.makedirs(os.path.join(self.src_folder, "folder_2"), exist_ok=True)
        shutil.copy(self.test_files["image_2012"], os.path.join(self.src_folder, "folder_2", "image1.jpg"))
        ...
        files_in_2011 = [f for f in os.listdir(os.path.join(self.dst_folder, "images", "2011")) if f.endswith(".jpg")]
        files_in_2012 = [f for f in os.listdir(os.path.join(self.dst_folder, "images", "2012")) if f.endswith(".jpg")]
        self.assertEqual(len(files_in_2011), 1)
        ...
        copied_image_2011 = os.path.join(self.dst_folder, "images", "2011", "image1.jpg")
        copied_image_2012 = os.path.join(self.dst_folder, "images", "2012", "image1.jpg")
    ...
    def test_empty_folder_deletion(self):
        ...
        empty_folder_path = os.path.join(self.src_folder, "empty_folder")
    ...
    def test_video_file_processing(self):
        ...
        shutil.copy(self.test_files["video_2013"], os.path.join(self.src_folder, "video_2013.mp4"))
        shutil.copy(self.test_files["video_2015"], os.path.join(self.src_folder, "video_2015.mp4"))
        ...
        self.assertTrue(os.path.exists(os.path.join(self.dst_folder, "videos", "2013", "video_2013.mp4")))
        self.assertTrue(os.path.exists(os.path.join(self.dst_folder, "videos", "2015", "video_2015.mp4")))
