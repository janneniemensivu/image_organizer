...
class TestFileProcessor(unittest.TestCase):
    ...
    def test_video_file_processing(self):
        ...
        shutil.copy(self.test_files["video_2013"], os.path.join(
            self.src_folder, "video_2013.mp4"))
        shutil.copy(self.test_files["video_2015"], os.path.join(
            self.src_folder, "video_2015.mp4"))
        ...
        self.assertTrue(os.path.exists(os.path.join(
            self.dst_folder, "videos", "2012", "video_2013.mp4")))
        self.assertTrue(os.path.exists(os.path.join(
            self.dst_folder, "videos", "2015", "video_2015.mp4")))
